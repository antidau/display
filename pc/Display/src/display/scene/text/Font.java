...
/**
 * Get the pixel data for the given char
 * @param c The character to which the data should be returned
 * @param fallback The char which should be rendered if the requested char is not available. If this is null or also not available, the return value will also be null.
