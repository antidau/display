...
//licensed under LGPL
        ...
        map.put('!', new int[]{0x00, 0x00, 0xbe, 0x00, 0x00});
        map.put('"', new int[]{0x00, 0x0e, 0x00, 0x0e, 0x00});
        ...
        map.put('\'', new int[]{0x00, 0x0a, 0x06, 0x00, 0x00});
        map.put('(', new int[]{0x00, 0x38, 0x44, 0x82, 0x00});
        map.put(')', new int[]{0x00, 0x82, 0x44, 0x38, 0x00});
        map.put('*', new int[]{0x10, 0x54, 0x38, 0x54, 0x10});
        map.put('+', new int[]{0x10, 0x10, 0x7c, 0x10, 0x10});
        map.put(',', new int[]{0x00, 0xa0, 0x60, 0x00, 0x00});
        map.put('-', new int[]{0x10, 0x10, 0x10, 0x10, 0x10});
        map.put('.', new int[]{0x00, 0xc0, 0xc0, 0x00, 0x00});
        map.put('/', new int[]{0x40, 0x20, 0x10, 0x08, 0x04});
        map.put('0', new int[]{0x7c, 0xa2, 0x92, 0x8a, 0x7c});
        map.put('1', new int[]{0x00, 0x84, 0xfe, 0x80, 0x00});
        ...
        map.put(':', new int[]{0x00, 0x6c, 0x6c, 0x00, 0x00});
        map.put(';', new int[]{0x00, 0xac, 0x6c, 0x00, 0x00});
        map.put('<', new int[]{0x00, 0x10, 0x28, 0x44, 0x82});
        map.put('=', new int[]{0x28, 0x28, 0x28, 0x28, 0x28});
        map.put('>', new int[]{0x82, 0x44, 0x28, 0x10, 0x00});
        ...
        map.put('I', new int[]{0x00, 0x82, 0xfe, 0x82, 0x00});
        ...
        map.put('i', new int[]{0x00, 0x88, 0xfa, 0x80, 0x00});
        map.put('j', new int[]{0x40, 0x80, 0x88, 0x7a, 0x00});
        map.put('k', new int[]{0x00, 0xfe, 0x20, 0x50, 0x88});
        map.put('l', new int[]{0x00, 0x82, 0xfe, 0x80, 0x00});
        ...
        map.put('{', new int[]{0x00, 0x10, 0x6c, 0x82, 0x00});
        map.put('|', new int[]{0x00, 0x00, 0xfe, 0x00, 0x00});
        map.put('}', new int[]{0x00, 0x82, 0x6c, 0x10, 0x00});
